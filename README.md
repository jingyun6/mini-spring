...
- 构造器参数 `@Qualifier` 覆盖 primary 与未标注参数继续选择 primary 的测试
- 当前共 45 个自动化测试
...
- 不支持方法注入
- 字段和构造器参数已支持 `@Qualifier` 精确选择，但两者的依赖解析逻辑尚未统一
...
| 2026-08-02 | v0.6.0 第四课：实现构造器参数 `@Qualifier` 精确选择并保持参数顺序 |
